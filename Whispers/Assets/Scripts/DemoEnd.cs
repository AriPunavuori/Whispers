...
public class Demoend : MonoBehaviour {
    ...
    public void EndGuess() {
        ...
        //var Pname = pm.playerDataList[pm.playerData.playerID / ]
        //var nameIdx =
        

        //if (dse.round == 0) {
        //    SMTalk.text = ((pm.playerData.playerID / 2) + " wanted " + Jones2 + " to draw " + rdm.guess.RemoveDiacritics());

        //} else {
        //    if (rnd == 0) {
        //        SMTalk.text = ("which looked like " + ch.guesses[gm.roundNumbr] + " to " + Jones2);
        //    } else if (rnd == 1) {
        //        SMTalk.text = ("which reminded " + Jones2 + " of " + ch.guesses[gm.roundNumbr]);
        //    } else if (rnd == 2) {
        //        SMTalk.text = ("which  " + Jones2 + " interpreted as " + ch.guesses[gm.roundNumbr]);
        //    }
        //}
    }
